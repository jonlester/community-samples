// Copied from: https://github.com/peter-murray/issue-forms-body-parser/

// The entry when a user has not provided a value in response
const NO_RESPONSE = '_No response_';
const separator = '###', label_marker_start = '>>', label_marker_end = '<<';
module.exports = class Parser {
  ...
  constructor() {
    this._config = {
      separator: separator,
      tag: {
        open: label_marker_start,
        close: label_marker_end
      }
    }
  }
